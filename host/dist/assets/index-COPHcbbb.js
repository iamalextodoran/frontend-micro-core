...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-uocnGSER.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-CL5_CR4f.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'Components':{url:'http://localhost:5001/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-uocnGSER.js', import.meta.url).href), loaded:1}},'react-dom':{'19.1.0':{get:()=>get(new URL('__federation_shared_react-dom-CL5_CR4f.js', import.meta.url).href), loaded:1}}
...
const __federation_var_ComponentsApp = await __federation_method_getRemote("Components" , "./App");
 let AppA = __federation_method_unwrapDefault(__federation_var_ComponentsApp); 
const __federation_var_ComponentsButton = await __federation_method_getRemote("Components" , "./Button");
 let Button = __federation_method_unwrapDefault(__federation_var_ComponentsButton); 
const App = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-green-100", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Core application here" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-mg bg-pink-100 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppA, {}) }),
